...
//Validating form input email field
	if(!emailaddress.test(contest.email) ){ 	
		emailfield = document.getElementById("input_email");
		emaillabel  = document.getElementById("emailerror");
		emaillabel.innerHTML = "Please Enter Correct Email Address";	
